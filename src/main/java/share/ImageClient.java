...
public class ImageClient extends SharingRole {
    private static final Logger logger = Logger.getLogger(ImageClient.class.getName());
    ...
    public static void main(String[] args) {
        ...
        PeerInfo user = new PeerInfo("localhost", "ImageClient", null, port);
        ...
        try {
            ...
            ImageClient client = new ImageClient(user, loginSetting.getImgName());
    ...
    public ImageClient(PeerInfo info, String imgName) {
        super(info);
            ...
            public void handleResponse(P2PMessage res) {
                switch (this.response.getCmd()) {
                    case resImgBlk:
                        ...
                        ImageClient.this.mergePeers(res);
                        break;
    ...
    class ClientRequestListen extends Thread {
        ...
        class RequestHandler extends Thread {
            ...
            private void handlerIncomingMsg() {
                ...
                ImageClient.this.mergePeers(this.request);
            }
